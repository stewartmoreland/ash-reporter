      ...
      const sampleData: ASHReport = {
        findings: [
          ...
          },
          {
            ...
            recommendation: 'Remove the hardcoded AWS access key and use environment variables or AWS IAM roles.'
          },
          {
            tool: 'Semgrep',
            severity: 'MEDIUM',
          ...
          },
          {
            ...
            recommendation: 'Enable versioning for better data protection and recovery options.'
          }
        ],
        metadata: {
